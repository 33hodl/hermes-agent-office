// Fresh showcase capture v7: unified chibi sprites, single-bubble, per-theme probe
...
(async () => {
  ...
  const switchAndShoot = async (theme) => {
    ...
    await p.screenshot({ path: `docs/screenshots/${theme}-v7.png` });
  };
